...
export class Home extends React.Component<RouteComponentProps<{}>, {}> {
    ...
    public render() {
        ...
        return <div>
            ...
            <ul>
                <li><strong>Client-side navigation</strong>. For example, click <em>Counter</em> then <em>baksida</em> to return here.</li>
            ...
            <div className="card-deck">
                <div className="card text-white bg-info mb-3" style={divStyle}>

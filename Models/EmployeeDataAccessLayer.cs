...
{
    public class EmployeeDataAccessLayer : IDataRepository<Employee>
    {
        readonly DatabaseEntitities _databaseEntitities;

        public EmployeeDataAccessLayer(DatabaseEntitities context)
        {
        ...
        public IEnumerable<Employee> GetAll()
        {
            try
            {
                return _databaseEntitities.Employees.ToList();
            }
            catch (Exception ex)
            {
